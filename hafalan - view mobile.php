...
if (!isset($_SESSION['user_id'])) {
    // Debugging: Tampilkan pesan jika pengguna belum login
    echo "User  is not logged in."; // Hapus atau ganti dengan logika lain di produksi
    header("Location: login.php"); // Arahkan ke halaman login
    exit();
} else {
    // Debugging: Tampilkan user_id jika pengguna sudah login
    // echo "User  is logged in: " . $_SESSION['user_id']; // Hapus atau ganti dengan logika lain di produksi
}
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=KFGQPC+Hafs+Uthmanic+Script&display=swap" rel="stylesheet" />
    <style>
        :root {
        ...
        *, *::before, *::after {
        ...
        .ayah-text {
            font-family: 'KFGQPC Hafs Uthmanic Script', serif; /* Mengganti font Arabic */
            font-size: 2.5rem;
            line-height: 1.3;
            direction: rtl;
            text-align: right;
